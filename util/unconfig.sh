...
${api} --no-git --needle="`${api} --get APPLICATION`" --sdk-needle="`${api} --get SDK_PATH`" --sdk-path="${SDK_PATH_NEEDLE}" --application-name="${APPLICATION_NEEDLE}" --skip="`${api} --get SKIP_FILES`"
